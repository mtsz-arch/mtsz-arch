...
| [Wykrywanie botów w komentarzach Reddit (Machine Learning) ](https://github.com/mtsz-arch/bot-detection-project)    | Projekt polega na stworzeniu modelu uczenia maszynowego, który analizuje komentarze użytkowników na platformie Reddit w celu wykrywania potencjalnej aktywności botów.  | [Python(numPy, Pandas,Matplotlib
Seaborn, sklearn)]  | [np. backend, routing]        | skończony |

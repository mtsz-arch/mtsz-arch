...
| [Wykrywanie botów w komentarzach Reddit (Machine Learning) ](https://github.com/mtsz-arch/bot-detection-project)    | Krótki opis projektu | [Excel, PowerBI]  | [link]       | [np. backend, routing]        | skończony |
| [Projekt 3]    | Krótki opis projektu | [np. SQL, Pandas]    | [link]       | [np. analiza danych]          | skończony |
| [E-Commerce Sales Analytics Dashboard](https://github.com/mtsz-arch/e-commerce-projekt)    | Kompletny projekt analizy danych e-commerce z wykorzystaniem SQL i Power BI (3 interaktywne dashboards)na datasecie 500k transakcji. | [Oracle SQL Developer, PowerBI]   | [link]       | [segmentacja RFM, analiza lifetime value (CLV) ]      | w trakcie |
